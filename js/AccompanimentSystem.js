...
class AccompanimentSystem {
    ...
    _initProgressions() {
        this.PROGRESSIONS = {
            ...
            // 浜千鳥 (C Major, 3/4)
            // 日本經典歌曲，簡譜版本
            // C大調: 1=C4(60), 2=D4(62), 3=E4(64), 5=G4(67), 6=A4(69), i=C5(72)
            // 曲式: A(16) + B(8) + A'(8) = 32小節, D.C.反覆
            'hamachidori': [
                // === A段 (第1段) ===
                // M1: 1 - 2
                { c: 'C', b: 3, h: '[1] - [2]', m: 1,
                  melody: [{n:60, s:0, d:2}, {n:62, s:2, d:1}] },
                // M2: 3 - 5
                { c: 'Em', b: 3, h: '[3] - [5]', m: 2,
                  melody: [{n:64, s:0, d:2}, {n:67, s:2, d:1}] },
                // M3: 6 - i
                { c: 'Am', b: 3, h: '[6] - [高1]', m: 3,
                  melody: [{n:69, s:0, d:2}, {n:72, s:2, d:1}] },
                // M4: 5 - -
                { c: 'C', b: 3, h: '[5] --', m: 4,
                  melody: [{n:67, s:0, d:3}] },
                // M5: 6 - 5
                { c: 'Am', b: 3, h: '[6] - [5]', m: 5,
                  melody: [{n:69, s:0, d:2}, {n:67, s:2, d:1}] },
                // M6: 3 2 1
                { c: 'C', b: 3, h: '[3] [2] [1]', m: 6,
                  melody: [{n:64, s:0, d:1}, {n:62, s:1, d:1}, {n:60, s:2, d:1}] },
                // M7: 2 - - (圓滑線連到M8)
                { c: 'G', b: 3, h: '[2] -- ⌢', m: 7,
                  melody: [{n:62, s:0, d:3}] },
                // M8: 2 - - (延續)
                ...
                { c: 'Em', b: 3, h: '[3] - [5]', m: 10,
                  melody: [{n:64, s:0, d:2}, {n:67, s:2, d:1}] },
                // M11: 6 - i
                { c: 'Am', b: 3, h: '[6] - [高1]', m: 11,
                  melody: [{n:69, s:0, d:2}, {n:72, s:2, d:1}] },
                // M12: 5 - -
                { c: 'C', b: 3, h: '[5] --', m: 12,
                  melody: [{n:67, s:0, d:3}] },
                // M13: 3 2 1
                { c: 'C', b: 3, h: '[3] [2] [1]', m: 13,
                  melody: [{n:64, s:0, d:1}, {n:62, s:1, d:1}, {n:60, s:2, d:1}] },
                // M14: 2 - 5
                { c: 'G', b: 3, h: '[2] - [5]', m: 14,
                  melody: [{n:62, s:0, d:2}, {n:67, s:2, d:1}] },
                // M15: 3 - - (圓滑線連到M16)
                { c: 'C', b: 3, h: '[3] -- ⌢', m: 15,
                  melody: [{n:64, s:0, d:3}] },
                // M16: 3 - -
                ...
                // === B段 ===
                // M17: 5 - 5
                { c: 'G', b: 3, h: 'B [5] - [5]', m: 17,
                  melody: [{n:67, s:0, d:2}, {n:67, s:2, d:1}] },
                // M18: 6 - 5
                { c: 'Am', b: 3, h: '[6] - [5]', m: 18,
                  melody: [{n:69, s:0, d:2}, {n:67, s:2, d:1}] },
                // M19: i - 6
                { c: 'Am', b: 3, h: '[高1] - [6]', m: 19,
                  melody: [{n:72, s:0, d:2}, {n:69, s:2, d:1}] },
                // M20: 5 - -
                { c: 'C', b: 3, h: '[5] --', m: 20,
                  melody: [{n:67, s:0, d:3}] },
                // M21: i - i
                { c: 'C', b: 3, h: '[高1] - [高1]', m: 21,
                  melody: [{n:72, s:0, d:2}, {n:72, s:2, d:1}] },
                // M22: i 6 5
                { c: 'Am', b: 3, h: '[高1] [6] [5]', m: 22,
                  melody: [{n:72, s:0, d:1}, {n:69, s:1, d:1}, {n:67, s:2, d:1}] },
                // M23: i - - (圓滑線連M24)
                { c: 'C', b: 3, h: '[高1] -- ⌢', m: 23,
                  melody: [{n:72, s:0, d:3}] },
                // M24: i - -
                ...
                // === A'段 (第2段結尾) ===
                // M25: 1 - 2
                { c: 'C', b: 3, h: "A' [1] - [2]", m: 25,
                  melody: [{n:60, s:0, d:2}, {n:62, s:2, d:1}] },
                // M26: 3 - 5
                { c: 'Em', b: 3, h: '[3] - [5]', m: 26,
                  melody: [{n:64, s:0, d:2}, {n:67, s:2, d:1}] },
                // M27: 6 - i
                { c: 'Am', b: 3, h: '[6] - [高1]', m: 27,
                  melody: [{n:69, s:0, d:2}, {n:72, s:2, d:1}] },
                // M28: 5 - -
                { c: 'C', b: 3, h: '[5] --', m: 28,
                  melody: [{n:67, s:0, d:3}] },
                ...
                // M30: 3 - 2
                { c: 'G', b: 3, h: '[3] - [2]', m: 30,
                  melody: [{n:64, s:0, d:2}, {n:62, s:2, d:1}] },
                // M31: 1 - - (圓滑線連M32)
                { c: 'C', b: 3, h: '[1] -- ⌢', m: 31,
                  melody: [{n:60, s:0, d:3}] },
                // M32: 1 - - (結束)
    ...
    _initSongSections() {
        this.SONG_SECTIONS = {
            ...
            'hamachidori': [
                { name: "全曲循環 (Full Song)", start: 1, end: 32 },
                { name: "A段 第1句 (M1-M8)", start: 1, end: 8 },
                { name: "A段 第2句 (M9-M16)", start: 9, end: 16 },
                { name: "B段 (M17-M24)", start: 17, end: 24 },
                { name: "A'段 結尾 (M25-M32)", start: 25, end: 32 }
            ]
        };
    }
